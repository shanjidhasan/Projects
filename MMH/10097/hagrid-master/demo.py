...
if __name__ == '__main__':
    ...
    # scripted_module.save("SSD.pt")
    # # Export mobile interpreter version model (compatible with mobile interpreter)
    # optimized_scripted_module = optimize_for_mobile(scripted_module)
    # optimized_scripted_module._save_for_lite_interpreter("SSD.ptl")
    ...
    # scripted_module = torch.jit.script(torchvision_model)
    # # Export full jit version model (not compatible mobile interpreter), leave it here for comparison
    # scripted_module.save("SSD.pt")
    # # Export mobile interpreter version model (compatible with mobile interpreter)
    # optimized_scripted_module = optimize_for_mobile(scripted_module)
    ...
    dummy_input = Variable(torch.randn(3, 320, 320))
    torch.onnx.export(torchvision_model, dummy_input, "SSDLite1.onnx", opset_version=11)
